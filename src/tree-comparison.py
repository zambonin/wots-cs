...
def table_4():
    table_header = (
        ...
        "    context of \\textsc{Xmss}, in tens of millions of CPU cycles\n"
        "    $(\\times 10^{7})$. Values in square brackets are the percentage\n"
        "    of the cost dedicated solely to encoding.}\\label{tab:xmss}\n"
        "  \\begin{tabular}{l*{6}{r}}\n"
        "    \\toprule\n"
